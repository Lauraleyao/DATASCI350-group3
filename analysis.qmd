...
- Correlation analysis based on the three lowest-GDP and three highest-GDP countries in each region, using the selected variables of interest.

- Heat map for correlation matrices of variables of interest to start exploring initial relationships.

- Linear regression model to see how the variables affected life expectancy.

- Machine learning analysis to see how important the variables are in relation to life expectancy.
